...
--*/
{
	...
	Nau8825CompleteIdleIrp(pDevice);
...
)
{
	...
	PNAU8825_CONTEXT deviceContext;
...
)
{
	...
	*Complete = TRUE;
...

	{
		...
		WDF_WORKITEM_CONFIG_INIT(&workitemConfig, Nau8825IdleIrpWorkItem);
...
)
{
	...
	case IOCTL_HID_SEND_IDLE_NOTIFICATION_REQUEST:
		...
		status = Nau8825ProcessIdleRequest(devContext, Request, &completeRequest);
		break;
